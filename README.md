[![DOI](https://zenodo.org/badge/1067993466.svg)](https://doi.org/10.5281/zenodo.21750154)
...
data.complete <- data.frame(plotcode = c(rep("A", 9), rep("B", 13),rep("C",7)),
                            plot.area = c(rep(1, 9), rep(0.2, 13),rep(0.3,7)),
                            census.yr = c(2000,2000,2010,2010,2024,2024,2010,2000,2024,2005,
                                          2005,2005,2020,2005,2020, 2005,2005,2020,2005,2005,
                                          2020,2020,2000,2000,2010,2000,2010,2000,2010),
                            ...
                            species = c("Araucaria angustifolia","Myrcia retorta","Araucaria angustifolia",
                                        ...
                                        "Eugenia indet","Araucaria angustifolia","Eugenia indet",
                                        "Myrcia retorta","Myrcia retorta","Myrcia retorta","Myrcia retorta"),
                            ...
                            genus = c("Araucaria","Myrcia","Araucaria","Myrcia","Araucaria","Myrcia",
                                      ...
                                      "Casearia","Alsophila", rep("Myrcia",7),"Eugenia","Araucaria","Eugenia",rep("Myrcia",4)),
                            family = c("Araucariaceae","Myrtaceae","Araucariaceae","Myrtaceae",
                                       ...
                                       "Salicaceae","Cyatheaceae",rep("Myrtaceae",8),"Araucariaceae","Myrtaceae",rep("Myrtaceae",4)),
                            latitude = c(rep(-27.84, 9), rep(-29.61, 20)),
                            longitude = c(rep(-50.23, 9), rep(-50.18, 20))) %>% 
