...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel(
      ...
      div(
        class = "welcome-panel",
        h2("Welcome to the app for analyses of Forest Structure and Dynamics ", style = "color: #2E8B57;"),
        p("This application provides tools for analysing forest structure, dynamics, and carbon fluxes."),
        ...
        tags$ul(
          ...
          tags$li(strong("Functional and taxonomic diversity"))
        ...
        h3("How to use:"),
        tags$ol(
          tags$li("Go to the 'Analyses' tab"),
          tags$li("Set your parameters in the sidebar (see README for details)"),
          tags$li("Click 'Run analysis' to process the estimates"),
          tags$li("Download results using the download button")
        ),
        
        h3("Data requirements:"),
        p("Your data should be in ForestPlots.net format (stem-level) with the following columns:"),
      ...
      sidebarLayout(
        sidebarPanel(
          ...
          selectInput("level",label = "community or species",
                      choices = c("community"), selected = "community"),
